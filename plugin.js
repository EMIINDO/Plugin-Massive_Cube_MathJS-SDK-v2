...

{
    ...
    ////////////////////////////////////////////
    const PLUGIN_ID = "Massive_Cube_MathJS";
    ////////////////////////////////////////////
    ...
    const PLUGIN_CLASS = SDK.Plugins.Massive_Cube_MathJS = class MathJSPlugin extends SDK.IPluginBase {
        constructor() {
            super(PLUGIN_ID);
            ...
            this._info.AddFileDependency({
                filename: "c3runtime/math.min.js",
